...
import com.salesmotoris.activity.inputdetailtransaction.InputDetailTransactionAdapter
...
class RecyclerItemTouchHelper(dragDirs: Int, swipeDirs: Int, private val listener: RecyclerItemTouchHelperListener): ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {
    ...
    override fun onSelectedChanged(
        ...
        if (viewHolder != null) {
            val foregroundView: View = (viewHolder as InputDetailTransactionAdapter.ViewHolder).viewForeground
